      ...
      <section className="relative pt-20 pb-16 px-6 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <p className="text-zinc-400 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
            {business.description || business.policies || "Bienvenido a nuestro espacio de atención profesional. Reserva tu servicio a continuación."}
          </p>
          ...
          <div className="mt-8 flex items-center justify-center gap-6 text-sm text-zinc-500 font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              {business.address || "Ver ubicación abajo"}
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="md:col-span-2 space-y-10">
          <div>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold tracking-tight">Servicios Disponibles</h2>
              <span className="text-[10px] uppercase tracking-widest font-bold text-zinc-600">Precios y Duración</span>
            </div>
                ...
                business.services.map((service) => (
                  ...
                  >
                    ...
                    <BookingButton 
                      ...
                      className="px-5 py-2.5 bg-white text-black text-xs font-bold rounded-xl hover:scale-105 active:scale-95 transition-all shadow-[0_4px_20px_rgba(255,255,255,0.1)] uppercase tracking-wider"
                    />
                  </div>
                ))
              ) : (
